...
namespace GradesPrototype.Data
{
    ...
    public class Student: IComparable<Student>
    {
        ...
        {
            // Verify the grade doen't belong to another student
            ...
            {
                // If the grade belongs to another student, throw an exception
    ...
    public class Teacher
    {
        ...
        {
            // Verify that the student isn't already in another class
            ...
            {
                // If student is in another class throw an exception
                throw new ArgumentException("Student", "Student is already assigned t another class");
            }
        }
        // Exercise 4: Task 2b: Remove a student from the class for this teacher
        public void RemoveFromClass(Student student)
        {
            // Verify the student is actually assigned to the class for this teacher
            ...
            {
                // If the student is not assigned to the class for this teacher, throw an exception
